...
class ExportDataVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    @IBAction func exportPressed(_ sender: Any) {
        ...
        var csvText = "SessionID,SessionDate,SessionDuration,SessionFrequency,RecordID,Timestamp,timeIntervalSince1970,MagX,MagY,MagZ\n"
            ...
            for session in sessions {
                ...
                for i in 0..<maxArray {
                    ...
                    if  i < SensorOutputs1.count {
                        sensorsInfo1 = "\(df.string(from: (SensorOutputs1[i].timeStamp as Date?)!)),\(String(describing: SensorOutputs1[i].timeStamp!.timeIntervalSince1970)),\(String(describing: SensorOutputs1[i].magX!)),\(String(describing: SensorOutputs1[i].magY!)),\(String(describing: SensorOutputs1[i].magZ!))"
                    }
    ...
    func getSensorOutput(sensorData: SensorData) -> SensorOutput {
        ...
        for characteristic in characteristics {
            ...
            if characteristic.toCharacteristicName?.name == "Mag" {
